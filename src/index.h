...
// Cada entrada del índice asocia una palabra con un arreglo de índices de
// documentos
typedef struct IndexEntry {
  char *word;       // La palabra indexada
  int *documentIds; // Arreglo de índices de documentos en los que aparece la
                    // palabra
...
// Recorrer la lista enlazada de documentos y agregar todas las palabras (de los
// filenames) al índice inverso
void index_documents(HashMap *map, DocumentGraph *graph, Document *docs);

// Buscar en el índice una palabra exacta (en minúsculas) y devolver el arreglo
// de índices de documentos y el número de resultados encontrados
