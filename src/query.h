...
// Guardar hasta max_results en el arreglo results y devolver el número de documentos encontrados.
int query_documents(Document *docs, Query *query, Document **results, int max_results);
